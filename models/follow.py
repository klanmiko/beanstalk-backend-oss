...
class Follow(db.Model):
	follower_uid = db.Column(db.ForeignKey("user.id"), nullable=False, primary_key=True, ondelete="CASCADE")
	following_uid = db.Column(db.ForeignKey("user.id"), nullable=False, primary_key=True, ondelete="CASCADE")
	timestamp = db.Column(db.DateTime)
	request = db.Column(db.Integer)

class FollowingAggregation(db.Model):
	user_id = db.Column(db.ForeignKey("user.id"), nullable=False, primary_key=True, ondelete="CASCADE")
